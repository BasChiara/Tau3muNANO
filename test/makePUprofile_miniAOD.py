...
outputFileNANO = cms.untracked.string('_'.join(['tau3muPUprofile', extension[options.isMC], options.tag])+'.root')
...
process.load('PhysicsTools.Tau3muNANO.nanoPUprofile_cff')
...
from PhysicsTools.Tau3muNANO.nanoPUprofile_cff import *
process = nanoAOD_customizePU(process)

process.nanoAOD_customizePU_step = cms.Path(process.nanoSequence)
...
process.schedule = cms.Schedule(
                                process.nanoAOD_customizePU_step,
                                process.endjob_step,
