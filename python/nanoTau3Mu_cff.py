...
nanoSequence = cms.Sequence(nanoMetadata + 
                            vertexSequence + metTables+           
                            globalTables+ vertexTables +
                            triggerObjectTau3MuTables + l1bits)

nanoSequenceMC = cms.Sequence(particleLevelT3mSequence + genParticleT3mSequence + metMC + 
                              globalTablesMC + genWeightsTable + genParticleT3mTables + lheInfoTable)
